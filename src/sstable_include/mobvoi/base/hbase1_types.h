 ...
 *  @generated
 */
#ifndef hbase1_TYPES_H
#define hbase1_TYPES_H
...
typedef struct _TScan__isset {
  _TScan__isset() : startRow(false), stopRow(false), timestamp(false), columns(false), caching(false), filterString(false), batchSize(false), sortColumns(false) {}
  bool startRow;
  bool stopRow;
  bool timestamp;
  bool columns;
...
class TScan {
 public:
  ...
  static const char* ascii_fingerprint; // = "62155223232E7F826B261E31F58AE540";
  static const uint8_t binary_fingerprint[16]; // = {0x62,0x15,0x52,0x23,0x23,0x2E,0x7F,0x82,0x6B,0x26,0x1E,0x31,0xF5,0x8A,0xE5,0x40};

  TScan() : startRow(), stopRow(), timestamp(0), caching(0), filterString(), batchSize(0), sortColumns(0) {
  }
